...
pub type fftw_r2r_kind_do_not_use_me = ::std::os::raw::c_int;
#[repr(C)]
...
extern "C" {
    pub static fftw_aoclversion: [::std::os::raw::c_char; 0usize];
}
extern "C" {
...
extern "C" {
    pub static fftwf_aoclversion: [::std::os::raw::c_char; 0usize];
}
extern "C" {
...
extern "C" {
    pub static fftwl_aoclversion: [::std::os::raw::c_char; 0usize];
}
extern "C" {
